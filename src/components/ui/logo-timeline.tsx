...
export function LogoTimeline({
  ...
  const techItems: LogoItem[] = [
    ...
    { label: "PyTorch", icon: "server" as LogoIconType, animationDelay: 0, animationDuration: 23, row: 4 },
    { label: "MLflow", icon: "server" as LogoIconType, animationDelay: 0, animationDuration: 25, row: 4 },
    { label: "Azure OpenAI", icon: "openai" as LogoIconType, animationDelay: 0, animationDuration: 21, row: 4 },
