    ...
    const categories = useMemo(() => [
        {
            ...
            items: [
                ...
                { id: '03', title: t('contact'), href: '/#contact-section' },
            ]
        },
        {
            ...
            items: [
                ...
                { id: '06', title: t('projects'), href: '/#projects-section' },
                { id: '07', title: t('achievements'), href: '/#certifications-section' },
            ]
        },
        {
            title: t('shortcuts.volume3'),
            items: [
                { id: '08', title: t('skills'), href: '/#skills-section' },
                { id: '09', title: t('menu.skills'), href: '/#skills-section' },
                { id: '10', title: t('tools'), href: '/#skills-section' },
            ]
        }
    ], [t]);
