  ...
  return (
    ...
    >
      <div style={wrapperStyle}>
        ...
        <div className="absolute left-1/2 top-[30px] sm:top-[40px] md:top-[60px] w-[500px] h-[500px] sm:w-[800px] sm:h-[800px] md:w-[1100px] md:h-[1100px] -translate-x-1/2 rounded-full pointer-events-none perspective-[1000px] will-change-transform transform-gpu">
          <motion.div 
          ...
          >
            {[...icons, ...icons, ...icons, ...icons].map((item, i, arr) => {
