...
export async function GET() {
  ...
  try {
    ...
    const competitions = [
        ...
        { title: "Predicting Store Sales (Time Series Forecasting)", msg: "Eksplorasi data cuaca BMKG berbasis API", type: "Community", teams: "6 Teams", time: "2 months ago" },
        ...
        { title: "FICO Credit Score Classification & Risk Assessment", msg: "FICO Credit Score Classification", type: "Community", teams: "49 Teams", time: "5 months ago" },
        { title: "Data Science Academy Hackathon Competition", msg: "Data Science Academy Hackathon", type: "Community", teams: "260 Teams", time: "10 months ago" },
        { title: "Advanced Data Mining & Classification Hackathon", msg: "Kompetisi Data Mining ADIKARA", type: "Community", teams: "23 Teams", time: "a year ago" },
